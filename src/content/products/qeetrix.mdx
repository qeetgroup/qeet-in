...
- **`@qeetrix/ui`** — the React component library. Forty-four components built on shadcn/ui with the Base UI registry and Tailwind CSS v4 — from buttons, inputs, and dialogs to data tables, command palette, charts, and identity-specific primitives like an OTP input and a copyable-secret field. ESM, server-component-ready, and shipped with the Cal Sans type family in three optical sizes.
